...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome += "🤖 <b>U2TG — парсинг YouTube и автопостинг</b>\n\n"
    welcome += "Я нахожу лучшие видео на YouTube и публикую их в ваш Telegram-канал.\n\n"
    ...
    if db_user.is_admin:
        ...
        welcome += (
            ...
            "2. /add_source — добавьте YouTube-канал или поиск\n"
