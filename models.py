...
class Project(Base):
    ...
    post_interval_minutes = Column(Integer, default=2)
...
class SourceChannel(Base):
    ...
    source_type = Column(String, default="channel")
    youtube_channel_id = Column(String, nullable=True)
    youtube_link_url = Column(String, nullable=True)
    youtube_search_query = Column(String, nullable=True)
    youtube_country = Column(String, nullable=True)
    youtube_category = Column(String, nullable=True)
    youtube_content_type = Column(String, default="all")
